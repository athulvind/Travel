import myStyle from './nav.module.css'
import myStyle2 from './home.module.css'
import myStyle3 from './service.module.css'
import myStyle5 from "./package.module.css"
import myStyle6 from "./review.module.css"
import myStyle7 from "./contact.module.css"
import { TextField, Button } from '@mui/material';
import myStyle8 from "./copyright.module.css"
   ...
   <div className='container-fluid bg-dark'>
          ...
          <nav style={{zIndex:1}} className="navbar navbar-expand-lg bg-warning ">
            <div className="container">
              ...
              <div className='d-flex align-items-center '>
                <div>
                  <a href=""><img className={myStyle.navimg1} src="./images/logo.avif" alt="" /></a>
                </div>
                <div>
        ...
        <div id='servicess'>
          ...
          <div className={myStyle3.servdivflex}>
            <div>
              <a className={myStyle3.servac} href=""><img className={myStyle3.servimgg} src="./images/drm1.jpeg" alt="" /></a>
            ...
            <div>
              <a className={myStyle3.servac} href=""><img className={myStyle3.servimgg} src="./images/drm3.webp" alt="" /></a>
              
            </div>
          </div>
          <div className={myStyle3.servdivflex}>
            <div>
              <a className={myStyle3.servac} href=""><img className={myStyle3.servimgg} src="./images/drm.jpg" alt="" /></a>
            ...
            <div>
              <a className={myStyle3.servac} href=""><img className={myStyle3.servimgg} src="./images/drm6.jpg" alt="" />
              </a>
        ...
        <div id='packagess' className={myStyle5.packtopdiv}>
          ...
          <div className={myStyle5.packmdiv}>
            ...
            <div className={myStyle5.packfdiv}>
              <div>
              <a className={myStyle5.packmdiv} href=""><img className={myStyle5.packimgg} src="./images/sp.jpg" alt="" /></a>
                <h1 className='text-danger mt-5 fs-3'>
                  Summer Packages
                </h1>
            ...
            <div className={myStyle5.packfdiv}>
              <div>
              <a className={myStyle5.packmdiv} href=""><img className={myStyle5.packimgg} src="./images/kp.webp" alt="" /></a>
            ...
            <div className={myStyle5.packfdiv}>
              <div>
              <a className={myStyle5.packmdiv} href=""><img className={myStyle5.packimgg} src="./images/gp.jpg" alt="" /></a>
        ...
        <div className='pt-2 bg-primary d-flex justify-content-evenly align-items-center'>
